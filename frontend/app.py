...
st.title("Dog Tracker Simulator - Dog: Mr Waffles - This is a proof of concept, reloads are needed")
...
def dashboard() -> None:
    ...
    with stats_col:
        ...
        if sim_state:
            ...
            st.write(f"Last tracker event ts: {st.session_state.dashboard_last_event_ts or '-'}")
